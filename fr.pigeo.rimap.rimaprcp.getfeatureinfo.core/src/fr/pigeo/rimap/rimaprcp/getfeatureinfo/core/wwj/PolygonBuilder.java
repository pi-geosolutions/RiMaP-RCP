...
public class PolygonBuilder extends AVListImpl {
    ...
    /**
     * Arms and disarms the polygon builder. When armed, the polygon builder monitors user input and builds the polygon in
     * response to the actions mentioned in the overview above. When disarmed, the polygon builder ignores all user input.
     *
     * @param armed true to arm the polygon builder, false to disarm it.
     */

...
import fr.pigeo.rimap.rimaprcp.cachemanager.wwutil.BLLTC;
...
public class BulkTable {
	...
	private BLLTC layersListComposite;
	...
	public void postConstruct(Composite parent, WwjInstance wwjInst){ //,  WorldWindow wwd) {
		...
		this.layersListComposite = new BLLTC(parent, SWT.BORDER_SOLID, wwjInst);
		((LayersListTableComposite) this.layersListComposite).addDragnDropSupport();

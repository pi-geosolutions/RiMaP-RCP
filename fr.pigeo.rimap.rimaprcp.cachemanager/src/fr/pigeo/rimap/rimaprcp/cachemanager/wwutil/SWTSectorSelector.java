 ...
 *
 * @author tag
 * @version $Id$ /* Copyright (C) 2012 United States Government as represented
 *          by the Administrator of the National Aeronautics and Space
 *          Administration. All Rights Reserved.
 */

public class SWTSectorSelector extends WWObjectImpl
		implements SelectListener, MouseListener, MouseMoveListener, RenderingListener {

	//public final static String SECTOR_PROPERTY = "gov.nasa.worldwind.SectorSelector";
	public final static String SECTOR_PROPERTY = "fr.pigeo.rimap.rimaprcp.cachemanager.wwutil.SWTSectorSelector";
	...
	public SWTSectorSelector(WorldWindow worldWindow)
	...
	public void enable() {
		...
		// this.setCursor(Cursor(this, SWT.CURSOR_CROSS));
	}
	...
	/*
	 * public Color getInteriorColor() { return
	 * this.getShape().getInteriorColor(); }
	 * 
	 * public void setInteriorColor(Color color) {
	 * this.getShape().setInteriorColor(color); }
	 * 
	 * public Color getBorderColor() { return this.getShape().getBorderColor();
	 * }
	 * 
	 ...
	 * 
	 * 
	 * public double getInteriorOpacity() { return
	 * this.getShape().getInteriorOpacity(); }
	 * 
	 * public void setInteriorOpacity(double opacity) {
	 * this.getShape().setInteriorOpacity(opacity); }
	 * 
	 * public double getBorderOpacity() { return
	 * this.getShape().getBorderOpacity(); }
	 * 
	 * public void setBorderOpacity(double opacity) {
	 * this.getShape().setBorderOpacity(opacity); }
	 * 
	 * public double getBorderWidth() { return this.getShape().getBorderWidth();
	 * }
	 * 
	...
	/*
	 * public void mousePressed(MouseEvent mouseEvent) { if
	 * (MouseEvent.BUTTON1_DOWN_MASK != mouseEvent.getModifiersEx()) return;
	 * 
	 * if (!this.isArmed()) return;
	 * 
	 * this.getShape().setResizeable(true);
	 * this.getShape().setStartPosition(null); this.setArmed(false);
	 * 
	 * mouseEvent.consume(); }
	 * 
	 * public void mouseReleased(MouseEvent mouseEvent) { if (MouseEvent.BUTTON1
	 * != mouseEvent.getButton()) return;
	 * 
	 ...
	 * 
	 * public void mouseDragged(MouseEvent mouseEvent) { if
	 * (MouseEvent.BUTTON1_DOWN_MASK != mouseEvent.getModifiersEx()) return;
	 * 
	 * if (this.getShape().isResizeable()) mouseEvent.consume(); // prevent view
	 * operations }
	 * 
